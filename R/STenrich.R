...
calculate_sum_distances = function(dists_mtx=NULL, select_spots=NULL){
  distances_high_spots = dists_mtx[select_spots, select_spots]
  upper_mtx_mask = DelayedArray::realize(upper.tri(distances_high_spots), BACKEND='HDF5Array') # Need to be DelayedArray to subset DelayedArray
