...
#
#
STdiff_old = function(x=NULL, samples=NULL, annot=NULL, ws=NULL, ks='dtc', deepSplit=NULL,
...
#
non_spatial_de_old = function(expr_df=NULL, combo=NULL, cores=NULL){
...
#
spatial_de_old = function(non_sp_mods=NULL, sp_topgenes=NULL, verbose=verbose, cores=NULL){
  # Paralellize lme models
  if(is.null(cores)){
