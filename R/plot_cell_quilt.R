##
#' @title plot_cell_quilt: Deconvolution scores at each spot from an spatial array
...
#
#
plot_cell_quilt <- function(x = NULL, cells=NULL, plot_who=NULL, color_pal='YlOrBr',
