...
<details>
  ...
  and recently, new methods have been added to read and analyze ST data. Seurat
  relies on a data structure called Seurat object to store data. We have implemented
  in `spatialGE` to read spatial transcriptomics experiments directly from Seurat 
  objects and complete analysis of spatial heterogeneity. 
...
brain_anterior <- SeuratData::LoadData("stxBrain", type="anterior1")
brain_posterior <- SeuratData::LoadData("stxBrain", type="posterior1")
```
