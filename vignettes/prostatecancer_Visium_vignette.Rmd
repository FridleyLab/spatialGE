...
```{r gene_krige, message=F, warning=F, error=F}
...
```{r, fig.width=10, fig.height=12, message=F, warning=F, error=F}
...
eplot <- plot_gene_quilt(prvisium, genes="KLK3", color_pal="sunset", purity=T, image=T, ptsize=0.5)
